import { expandAqaBusinessTopicSelection } from "../subjects/aqa-business";
import { expandAqaEnglishLanguageTopicSelection } from "../subjects/aqa-english-language";
import { expandAqaEnglishLiteratureTopicSelection } from "../subjects/aqa-english-literature";
import {
  expandTopicSelection,
  selectQuestionUnits,
  sortQuestionUnitsForRendering,
} from "../../domain/subjects/aqa-geography";
import type { QuestionMixProfile, QuestionBankPart, QuestionUnit } from "@/shared/domain/paper";
import { buildRealPaperBenchmark, estimateMarksFromTimeMinutes } from "../benchmarking";
import {
...
import { expandEdexcelBusinessTopicSelection } from "../subjects/edexcel-business";
import { expandEdexcelFrenchTopicSelection } from "../subjects/edexcel-french";
import { expandEdexcelMathematicsTopicSelection } from "../subjects/edexcel-mathematics";
import { expandEdexcelSeparateScienceTopicSelection } from "../subjects/edexcel-separate-science";
import { expandOcrComputerScienceTopicSelection } from "../subjects/ocr-computer-science";
import { filterUnitsByCopyrightPlaceholders, filterUnitsByDanglingContext, filterUnitsByFigureResolvability } from "../../domain/integrity";
import {
