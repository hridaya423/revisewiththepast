...
import { getAqaBusinessTopicTree } from "../subjects/aqa-business";
import { AQA_GEOGRAPHY_TOPIC_TREE } from "../../domain/subjects/aqa-geography";
import type { QuestionUnit } from "@/shared/domain/paper";
import type { TopicTreeNode } from "@/shared/domain/topic";
import { getAqaEnglishLanguageTopicTree } from "../subjects/aqa-english-language";
import { getAqaEnglishLiteratureTopicTree } from "../subjects/aqa-english-literature";
import { buildCombinedScienceTopicTree } from "../../domain/subjects/combined-science";
import { getEdexcelBusinessTopicTree } from "../subjects/edexcel-business";
import { getEdexcelFrenchTopicTree } from "../subjects/edexcel-french";
import { getEdexcelMathematicsTopicTree } from "../subjects/edexcel-mathematics";
import { getEdexcelSeparateScienceTopicTree } from "../subjects/edexcel-separate-science";
import { getOcrComputerScienceTopicTree } from "../subjects/ocr-computer-science";
import type { CoverExamContext, PaperMakerSubjectDefinition, PaperOption } from "../../domain/subjects";
