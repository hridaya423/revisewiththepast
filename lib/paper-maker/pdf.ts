...
const TURN_OVER_MIN_BLANK_HEIGHT = 72;
...
function drawTurnOverForNextQuestion(page: import("pdf-lib").PDFPage, blankTop: number) {
  if (blankTop - SHORT_PAGE_BOTTOM_MARGIN < TURN_OVER_MIN_BLANK_HEIGHT) return;
